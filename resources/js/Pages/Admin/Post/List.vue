                ...
                >
                    ...
                    <div class="block w-full overflow-x-auto">
                        ...
                        <table class="w-full bg-transparent border-collapse ">
                            ...
                            <tbody>
                                <tr
                                    v-for="(content, index) in posts.data"
                                    :key="content.id"
                                >
                                    <th
                                    ...
                                    <td
                                        class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4 space-s-5 flex"
                                    >
                                        <inertia-link
                                            as="button"
                                            :href="
                                                '/panel/post/view/' + content.id
                                            "
...
export default {
    ...
    data: function() {
        return {
            ...
            nextpage: this.posts.next_page_url
            //   tableData: []
        };
    },
    methods: {
        destroy(e) {
            ...
            this.$inertia.delete(this.route("panel.postdestroy", e.id), {
