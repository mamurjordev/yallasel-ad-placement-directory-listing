    ...
    <div class="flex flex-wrap mt-4">
      <div class="w-full px-4">
        ...
        >
          ...
          <div class="block w-full overflow-x-auto">
            ...
            <table class="items-center w-full bg-transparent border-collapse">
              ...
              <tbody>
                <tr v-for="(content, index) in cities.data" :key="content.id">
                  <th
                  ...
                  >
                    <inertia-link
                      as="button"
                      :href="$route('panel.city.edit', content.id)"
        ...
        <section>
          ...
          >
            <div v-for="link in cities.links" :key="link.id" class="">
              <inertia-link
                v-html="link.label"
                v-if="link.url"
                :href="link.url"
...
export default {
  ...
  data: function () {
    return {
      Headers: ["SR", "City Name", "City Name Arabic", "Created at", "Updated at", "Action"],
      nextpage: this.cities.next_page_url,
      //   tableData: []
    };
  },
  methods: {
    destroy(e) {
      ...
      this.$inertia.delete(this.route("panel.city.destroy", e.id), {
