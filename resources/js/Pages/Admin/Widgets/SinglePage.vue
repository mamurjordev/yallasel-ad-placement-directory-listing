                ...
                <div class="grid md:grid-cols-2 gap-5">
                    ...
                    >
                        <div class="">
                            ...
                            <draggable
                                class="dragArea list-group space-y-3 border border-gray-700"
                                tag="ul"
                                :list="usedWidgets"
                                handle=".handle"
                                group="people"
                            ...
                            >
                                <li
                                    class="list-group-item cursor-pointer bg-white border border-gray-600 px-5"
    ...
    methods: {
        ...
        photoUpload(id) {
            ...
            this.usedWidgets.forEach(element => {
                if (element.id == id) {
                    this.uploadImage["image" + id] = image.files[0];

                    element.image = "image" + id + "." + ext;
